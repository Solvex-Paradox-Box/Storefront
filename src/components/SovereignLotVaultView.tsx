              ...
              {filteredLots.map((lot) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4 pt-2 border-t border-slate-800/80 bg-black/40 flex flex-col gap-3">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <button
                          ...
                          className="w-full bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 py-2 rounded-lg text-xs font-bold font-mono flex items-center justify-center space-x-1.5 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="w-full bg-amber-400 hover:bg-amber-300 text-black py-2 rounded-lg text-xs font-black font-mono flex items-center justify-center space-x-1.5 transition-transform hover:scale-[1.02] shadow-[0_0_12px_rgba(245,158,11,0.3)]"
                        >
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#0b0f19] border border-cyan-500/50 rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-end space-x-3 pt-3 border-t border-slate-800">
              ...
              >
                Acquire Lot ({activeInspectorLot.priceEth.toFixed(4)} ETH)
              </button>
            </div>
          </div>
        </div>
